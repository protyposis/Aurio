...
namespace AudioAlign.FFmpeg {
    internal class Interop32Wrapper : IInteropWrapper {
        ...
        public int stream_read_frame(IntPtr instance, out long timestamp, out IntPtr data) {
            return Interop32.stream_read_frame(instance, out timestamp, out data);
        }

        public void stream_seek(IntPtr instance, long timestamp) {
            Interop32.stream_seek(instance, timestamp);
        }
