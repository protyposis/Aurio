...
namespace Aurio.Test.HugeControlRendering
{
    public partial class SineWave : Control
    {
        ...
        public static readonly DependencyProperty SineRenderModeProperty = DependencyProperty.Register(
            "SineRenderMode", typeof(SineRenderMode), typeof(SineWave),
        ...
        private Geometry CreateGeometry(List<double> samples)
        {
            ...
            transformGroup.Children.Add(new TranslateTransform(ViewportHorizontalOffset, ActualHeight / 2));
        ...
        private BitmapSource RenderBitmapTransformless(List<double> samples)
        {
            ...
            RenderTargetBitmap bmp = new RenderTargetBitmap(samples.Count, (int)ActualHeight, 96, 96, PixelFormats.Pbgra32);
