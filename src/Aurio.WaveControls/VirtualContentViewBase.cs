...
namespace Aurio.WaveControls
{
    public class VirtualContentViewBase : ContentControl, VirtualView
    {
        ...
        {
            return VirtualViewBase.PhysicalToVirtualOffset(
        ...
        {
            return VirtualViewBase.VirtualToPhysicalOffset(
                VirtualViewportWidth,
                ActualWidth,
                virtualOffset
            );
        ...
        {
            return VirtualViewBase.PhysicalToVirtualIntervalOffset(
        ...
        {
            return VirtualViewBase.VirtualToPhysicalIntervalOffset(
                VirtualViewportInterval,
                ActualWidth,
                virtualOffset
            );
